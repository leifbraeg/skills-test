...
name: aperio-update
description: >
  Generate a weekly status update for Mission Aperio at Taxfix and publish it to the Notion Updates database.
  Use this skill whenever the user says things like "aperio update", "weekly update", "mission update",
  "write the aperio update", "post the weekly aperio status", or any request to create or draft
  a new entry in the Aperio Updates database. Also trigger when the user references writing a
  status update for the mission charter, PLT, or stakeholders about Aperio progress.
---
